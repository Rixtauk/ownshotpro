    ...
    return (
      <Card className="h-full">
        ...
        <CardContent className="flex-1">
          <div className="h-64 bg-muted rounded-xl flex flex-col items-center justify-center text-muted-foreground gap-4">
            <div className="w-16 h-16 rounded-full bg-muted flex items-center justify-center">
              <ImageIcon className="w-8 h-8 text-muted-foreground" />
            </div>
            <p className="text-muted-foreground font-medium">Upload an image to see preview</p>
          </div>
        </CardContent>
      </Card>
    );
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div
              className="relative bg-muted rounded-xl overflow-hidden cursor-pointer group"
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div
              className={`relative bg-muted rounded-xl overflow-hidden ${enhancedUrl ? 'cursor-pointer group' : ''}`}
            ...
            >
              {enhancedUrl ? (
                ...
                <div className="h-48 flex flex-col items-center justify-center text-muted-foreground gap-3">
                  ...
                  <p className="text-muted-foreground font-medium">Click Generate to enhance</p>
                </div>
              )}
            </div>
